...
$TRANSLATIONS = array (
 ...
 "Audit_log notification" => "Audit_log notification",
 "All Activities" => "All Activities","Activities by you" => "Activities by you",
 "Activities by others" => "Activities by others","Shares" => "Shares",
 "Files" => "Files","in %s" => "in %s","%s and %s" => "%s and %s",", " => ", ",
 ...
 "Enable RSS feed" => "Enable RSS feed","Notifications" => "Notifications",
 "Mail" => "Mail","Stream" => "Stream",
 ...
 "Send emails:" => "Send emails:","Hourly" => "Hourly","Daily" => "Daily",
 "Weekly" => "Weekly","Audit_log feed" => "Audit_log feed",
