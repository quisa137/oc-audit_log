...
class ParameterHelper {
  ...
  *         Type of parameters, if they need special handling
  * @param bool $stripPath
  *         Shall we remove the path from the filename
  ...
  *         Type of parameter, if it needs special handling
  * @param bool $stripPath
  *         Shall we remove the path from the filename
  * @param bool $highlightParams
  * @return string
  ...
  * @param array $params
  * @param string $paramType
  *         Type of parameters, if it needs special handling
  * @param bool $stripPath
  *         Shall we remove the path from the filename
  * @param bool $highlightParams
  * @return string
