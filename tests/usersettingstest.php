...
class UserSettingsTest extends \PHPUnit_Framework_TestCase {
	public function setUp() {
		$preferences = array(
			array('test1', 'audit_log', 'notify_stream_type1', '1'),
			array('test1', 'audit_log', 'notify_stream_type2', '2'),
			array('test2', 'audit_log', 'notify_stream_type1', '0'),
			array('test2', 'audit_log', 'notify_stream_type2', '0'),
			array('test3', 'audit_log', 'notify_stream_type1', ''),
			array('test4', 'audit_log', 'notify_stream_type1', '3'),
			array('test6', 'audit_log', 'notify_stream_file_nodefault', '1'),
			array('test6', 'audit_log', 'notify_stream_file_created', '1'),

			array('test1', 'audit_log', 'notify_email_type1', '1'),
			array('test1', 'audit_log', 'notify_email_type2', '2'),
			array('test2', 'audit_log', 'notify_email_type1', '0'),
			array('test2', 'audit_log', 'notify_email_type2', '0'),
			array('test3', 'audit_log', 'notify_email_type1', ''),
			array('test4', 'audit_log', 'notify_email_type1', '3'),
			array('test5', 'audit_log', 'notify_email_type1', '1'),
			array('test6', 'audit_log', 'notify_email_shared', '1'),
			array('test6', 'audit_log', 'notify_email_file_created', '1'),

			array('test1', 'audit_log', 'notify_setting_batchtime', '1'),
			array('test2', 'audit_log', 'notify_setting_batchtime', '2'),
			array('test3', 'audit_log', 'notify_setting_batchtime', '3'),
			array('test4', 'audit_log', 'notify_setting_batchtime', '4'),
			array('test6', 'audit_log', 'notify_setting_batchtime', '2700'),
		);
